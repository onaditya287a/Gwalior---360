  ...
  head: () => ({
    meta: [
      ...
      { title: "Explore Gwalior — Heritage Travel & 360° Virtual Tours" },
      {
        name: "description",
        content:
          "Discover the historical and cultural heritage of Gwalior, India — plan a visit or explore interactive 360° virtual tours.",
      },
      { property: "og:site_name", content: "Explore Gwalior" },
